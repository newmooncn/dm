...
#                wf_service.trg_validate(uid, 'purchase.order', po.id, 'purchase_cancel', cr)
    ...
    def _email_notify(self, cr, uid, ids, mail_type, context=None):
        mail_types = {'confirmed':{'action':'need your approval','groups':['dmp_purchase.group_pur_req_checker']},
                  'approved':{'action':'approved, please issue PO','groups':['dmp_purchase.group_pur_req_buyer']},
                  'rejected':{'action':'was rejected, please check','groups':[]},
                  'in_purchase':{'action':'is in purchasing','groups':[],},
                  'done':{'action':'was done','groups':['dmp_purchase.group_pur_req_buyer']},
