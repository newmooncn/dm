...
##############################################################################
{
    'name': 'DMP MRP Producing product',
    'version': '1.0',
    'category': 'Customization',
    'author': 'DMEMS',
    'website': 'www.dmems.com',
    'description': """
Manufacture Producing product
1.When do MO's produce, generate a finished stock picking for the finished stock moving everytime, 
