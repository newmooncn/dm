...
class stock_picking(osv.osv):
    ...
    _columns = {   
        ...
        'deliver_method': fields.selection([('home_delivery','Home delivery service'),('customer_pick','Customer Picking'),('courier','Courier')],\
                                           'Deliver Method', size=64), 
        'courier_ticket': fields.char('Courier Ticket#', size=64),        
    } 
    ...
    def do_partial(self, cr, uid, ids, partial_datas, context=None):
        ...
        vals = {'deliver_ticket_no':context.get('deliver_ticket_no') and context.get('deliver_ticket_no') or None,\
                'deliver_method':context.get('deliver_method') and context.get('deliver_method') or None}
