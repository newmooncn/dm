...
class hr_rpt_attend_emp_day(osv.osv):
    ...
    def new_attend_month(self, cr, uid, ids, context=None):
        ...
        form_view = self.pool.get('ir.model.data').get_object_reference(cr, uid, 'dmp_hr', 'hr_rpt_attend_month_view')
    ...
    def view_attend_month(self, cr, uid, ids, context=None):
        ...
        if len(rpt_month_ids) > 1:
            #got to list page
            act_id = self.pool.get('ir.model.data').get_object_reference(cr, uid, 'dmp_hr', 'hr_rpt_attend_month_action')
    ...
    def run_report(self, cr, uid, ids, context=None):
        ...
        form_view = self.pool.get('ir.model.data').get_object_reference(cr, uid, 'dmp_hr', 'view_hr_rpt_attend_emp_day_line_tree')
        form_view_id = form_view and form_view[1] or False
        return {
