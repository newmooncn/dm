...
class account_account(osv.osv):
    ...
    '''
    Handle the account.account.bal_direct field logic, to give the correct balance value
    johnw, 11/23/2014
    '''
    def __compute(self, cr, uid, ids, field_names, arg=None, context=None,
        ...
        """
        mapping = {
            #return the balance by the 'bal_direct' setting, johnw, 11/23/2014
            #'balance': "COALESCE(SUM(l.debit),0) - COALESCE(SUM(l.credit), 0) as balance",
            'balance': "case max(act.bal_direct) \n \
                when 'c' then COALESCE(SUM(l.credit),0) - COALESCE(SUM(l.debit), 0) \n \
        ...
        if children_and_consolidated:
            ...
            #add the join with table account_account, johnw, 11/23/2014
    ...
    '''
    since copied the __compute() related fields to this class, and some fields use this function, 
    so copy _set_credit_debit() here without changing
    johnw, 11/23/2014
    '''    
