...
report_sxw.report_sxw('report.hr.rpt.attend.month.general', 'hr.rpt.attend.month', 'addons/dmp_hr_attend/wizard/hr_rpt_attend_month_general.rml', parser=rml_parser_ext, header='internal landscape')
report_sxw.report_sxw('report.hr.rpt.attend.month.notification', 'hr.rpt.attend.month', 'addons/dmp_hr_attend/wizard/hr_rpt_attend_month_notification.rml', parser=rml_parser_ext, header='internal')
report_sxw.report_sxw('report.hr.rpt.attend.month.inspection', 'hr.rpt.attend.month', 'addons/dmp_hr_attend/wizard/hr_rpt_attend_month_inspection.rml', parser=rml_parser_ext, header='internal landscape')
